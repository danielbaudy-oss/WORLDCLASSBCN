// Index the Catalunya convenio text into material_embeddings for RAG
// Run on Pi: GEMINI_API_KEY=... SUPABASE_SERVICE_KEY=... node scripts/index-convenio-cat.js
const fs = require('fs');
...
const FILE_NAME = 'II Conveni Col·lectiu Ensenyament No Reglada Catalunya (DOGC 2025)';
const DRIVE_FILE_ID = 'convenio-cat-dogc-2025';
...
async function deleteExisting() {
  ...
  console.log('Deleted any existing Catalunya convenio chunks');
}
...
async function main() {
  ...
  const text = fs.readFileSync('/home/baudy/convenio-catalunya.txt', 'utf8');
